<div id='cssmenu'>
    <ul>
        ...
        <li> <?php echo $this->Html->link(__('Home'), array('controller' => 'reports', 'action' => 'index')); ?></li>
	    <?php echo "<li>" . $this->Html->link(__('Daily Report'), array('controller' => 'reports', 'action' => 'export_day/display')) . "</li>"; ?></li>
...
<h2><?php  echo __('Reports');?></h2>
	...
	<h3> Monthly from <?php echo $last_month;?> to <?php echo $today;?></h3>
	<table>
...
<?php 
//echo $this->Html->link(__('Save as CSV'), array('controller' => 'reports', 'action' => 'export_monthly_csv'), array('class' => 'saveAsBtn')) ; 
?>
