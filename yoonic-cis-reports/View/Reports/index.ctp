    ...
    <body>
        ...
        <div id='cssmenu'>
            ...
            <ul>
                ...
                <li class = active> <?php echo $this->Html->link(__('Home'), array('controller' => 'reports', 'action' => 'index')); ?> </li>
		<li>  <?php echo $this->Html->link(__('Reports'), array('controller' => 'reports', 'action' => 'export_day/display')); ?></li>
		<li> <?php echo $this->Html->link('Archive', 'http://maxis.cs.yoonic.tv/log/reports/'); ?></li> 
...
<span id="report_error" style="display:none;">Please input Start Date and End Date before generating reports </span>
    ...
    <br/>
    <br/>
    <h3>Total Number of Subscription : <?php echo $total_subscription_count; ?></h3>
    <br> 
    </br>
    <h3>Total Number of Active Subscription : <?php echo $total_active_subscription_count; ?></h3>
    <br> 
    </br>
    <h3>Total Number of New Subscribers(Monthly from <?php echo $last_month; ?> to <?php echo $last_month_end; ?>) : <?php echo $yoonic_subscribers_count_month; ?></h3>    
    <br> 
    </br>
    <h3>Total Number of New Subscribers(Weekly from <?php echo $last_week; ?> to <?php echo $last_week_start; ?>) : <?php echo $yoonic_subscribers_count_week; ?></h3>
