...
<h2><?php  echo __('Reports');?></h2>
	...
	<h3>Weekly from <?php echo $last_week;?> to <?php echo $today;?></h3>	
	<table>
...
<?php 
//echo $this->Html->link(__('Save as CSV'), array('controller' => 'reports', 'action' => 'export_weekly_csv'), array('class' => 'saveAsBtn')) ;
?>
